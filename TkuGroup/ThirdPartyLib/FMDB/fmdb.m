...
// What is this function for?  Think of it as a template which a developer can use to report bugs.
 
//If you have a bug, make it reproduce in this function and then let the developer(s) know either via the github bug reporter or the mailing list.
